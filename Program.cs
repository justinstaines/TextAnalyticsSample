...
{
    /// <summary>
    /// This is a sample program  that shows how to use the Azure ML Text Analytics app
    /// Justin S
    /// Uses this end point https://datamarket.azure.com/dataset/explore/amla/text-analytics
    /// Gives back sentiment score from 0 (negative) to 1 (positive)
    /// </summary>
    class Program
    {
